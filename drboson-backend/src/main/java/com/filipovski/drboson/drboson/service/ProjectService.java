...
public interface ProjectService {
    ...
    Project createUserProject(User user, String name, String description) throws Exception;

    Project getProject(UUID projectId) throws Exception;

    Project updateProject(UUID projectId, String name, String description) throws Exception;
